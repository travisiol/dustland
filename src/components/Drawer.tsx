...
const groups = [
  {
    title: "The body",
    items: [
      { label: "Lunar map", href: "#map", note: "0% claimed" },
      { label: "Plots by region", href: "#ledger", note: `${worldTotals.totalPlots}` },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Token", href: "#faq", note: "$DUST" },
    ],
  },
] as const;
        ...
        <div className="fixed inset-0 z-[60] flex">
          ...
          <nav className="w-[300px] max-w-[86vw] overflow-y-auto border-l border-rule bg-field">
            <div className="flex items-center justify-between border-b border-rule px-5 py-4">
              <Label className="text-chalk">Dustland</Label>
              <button
                type="button"
                onClick={() => setOpen(false)}
                aria-label="Close menu"
